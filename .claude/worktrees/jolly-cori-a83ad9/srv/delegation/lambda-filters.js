...
// ─── Local Lambda Filter Resolution (Scenario C filter) ─────────────────────────
//
// When a delegated entity has local associations (Scenario C), the client can filter
// using lambdas on those local collections: Customers?$filter=bookmarks/any(b:b/label eq '...')
//
