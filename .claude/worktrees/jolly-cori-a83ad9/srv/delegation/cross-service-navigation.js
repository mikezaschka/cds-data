...
//
// Two sub-cases:
//   N1 (local→remote): source is local, target is delegated.
//       Read local FK, then query remote by key.
//   N2 (remote→local): source is delegated, target is local.
//       Extract source key from from.ref, query local by FK.

/**
 * N1/N3: Resolves navigation from a LOCAL entity to a REMOTE (delegated) entity.
 *
...
/**
 * N2: Rewrites a remote→local navigation CQN into a simple FK-filtered local query.
 *
