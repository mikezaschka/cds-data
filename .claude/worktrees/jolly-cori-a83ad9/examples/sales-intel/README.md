...
| Federation Monitor | `/federation/Federations` + `/federation/run` |
...
3. Run [`workbench/http/21-expand-scenario-b.http`](workbench/http/21-expand-scenario-b.http) — see local notes stitched with live Northwind customers and orders in a single query.
