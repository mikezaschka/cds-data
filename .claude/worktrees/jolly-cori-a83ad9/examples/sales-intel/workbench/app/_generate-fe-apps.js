...
//   'federation' → /federation/   (plugin management service)
const APPS = [
    ...
    { dir: 'federation-monitor', id: 'sales.federationmonitor', title: 'Federation Monitor', entity: 'Federations', dataSource: 'federation' }
]

const DATA_SOURCES = {
    sales:      { uri: '/odata/v4/sales-intel/' },
    federation: { uri: '/federation/' }
}
