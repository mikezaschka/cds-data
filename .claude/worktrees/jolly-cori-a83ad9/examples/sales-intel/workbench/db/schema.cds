...
// Demonstrates: V4 delegation, plus Scenario C — remote→local $expand resolution
// for `notes`, `tasks`, `risk` against the local DB when the client asks for them.
@federation.delegate
...
// Orders with renamed association → enables Scenario A (remote→remote) expand
