...
- [x] **Federation Monitor** — List Report over plugin's `DataFederationService.Federations` (Admin)
...
- [ ] Shipment Alerts (Scenario B across a local CAP provider)
...
- [ ] Federation Insights (ALP over `ReplicationRuns`)
...
- Cross-service navigation (N1/N2/N5 patterns)
- `$search` forwarding
