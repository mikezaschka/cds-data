...
The test file [`test/delegation.test.js`](https://github.com/mikezaschka/cds-data-federation/blob/main/test/delegation.test.js) demonstrates both patterns:
...
- [CAP: CaLeSi — Delegation](https://cap.cloud.sap/docs/guides/integration/calesi#delegation) — the `req => remote.run(req.query)` pattern
