...
- [`$expand` Scenarios](expand-scenarios.md) — how consumption views enable three distinct cross-service `$expand` patterns.
- [Getting Started → First Delegation](../getting-started/first-delegation.md) — hands-on example.
- [Reference → Annotations](../reference/annotations.md) — complete option reference.
