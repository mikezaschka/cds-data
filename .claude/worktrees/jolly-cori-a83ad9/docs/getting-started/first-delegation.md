...
- Cross-service `$expand` (see [`$expand` Scenarios](../concepts/expand-scenarios.md)).
...
- [Concepts → `$expand` Scenarios](../concepts/expand-scenarios.md) — how cross-service expand works.
