...
hero:
  ...
  actions:
    - theme: brand
      text: Introduction
      link: /pipeline/guide/introduction
    - theme: alt
      text: Get started
      link: /pipeline/guide/get-started
    - theme: alt
      text: Reference
...
features:
  ...
  - icon: 🚀
    title: Get started
    details: Northwind walkthrough — consumption view, your first pipeline, and the Pipeline Console.
    link: /pipeline/guide/get-started
    linkText: Open guide
  - icon: 📐
    title: Concepts
    details: Terminology, inference rules, consumption views, and change history vs pipelines.
    link: /pipeline/guide/concepts/
  - icon: 📥
    title: Sources
    details: OData V2 / V4, REST, CQN, and pluggable custom adapters.
    link: /pipeline/guide/sources/
  - icon: 📤
    title: Targets
    details: Local DB, remote OData, and custom write paths.
    link: /pipeline/guide/targets/
  - icon: 🧑‍🍳
    title: Recipes
    details: Replicate, materialize, multi-source fan-in, hooks, and scheduling.
    link: /pipeline/guide/recipes/
  - icon: 🖥️
    title: Pipeline Console
    details: Mount the pre-built monitor UI from the npm package — CAP reuse & compose.
    link: /pipeline/guide/pipeline-console
    linkText: Mount the UI
  - icon: ✨
  ...
  - icon: 📡
    ...
    link: /pipeline/reference/management-service
  - icon: ↪️
    title: Event hooks
    details: before / on / after for every phase from START through DONE.
    link: /pipeline/guide/recipes/event-hooks
---

New here? Read **[Introduction](/pipeline/guide/introduction)** (what, why, and scope) before the hands-on walkthrough.
